-- Script generated by WINDEV on 11/12/2025 19:08:43
-- Tables of Stock.wda analysis
-- for PostgreSQL

-- Creating the Guia_deColada_retiro table
CREATE TABLE "Guia_deColada_retiro" (
    "Guia_deColada_retiroID" SERIAL8  PRIMARY KEY ,
    "fecha" TIMESTAMP ,
    "Legajo_movimiento" INTEGER DEFAULT 0,
    "ProductoID" INTEGER DEFAULT 0,
    "Cantidad" REAL DEFAULT 0,
    "Guia_de_ColadaID" BIGINT DEFAULT 0);
CREATE INDEX "WDIDX_Guia_deColada_retiro_ProductoID" ON "Guia_deColada_retiro" ("ProductoID");
CREATE INDEX "WDIDX_Guia_deColada_retiro_Guia_de_ColadaID" ON "Guia_deColada_retiro" ("Guia_de_ColadaID");

CREATE INDEX "WDIDX_Guia_deColada_retiro_ProductoID" ON "Guia_deColada_retiro" ("ProductoID");
CREATE INDEX "WDIDX_Guia_deColada_retiro_Presupuesto" ON "Guia_deColada_retiro" ("Presupuesto");
" REAL DEFAULT NULL,
